      ...
      <div className="max-w-7xl mx-auto pt-20 pb-12 px-6 md:px-12 lg:px-24">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="col-span-1 lg:col-span-1">
            <h3 className="text-2xl font-bold mb-6">AcmeCorp</h3>
            <p className="text-white/80 mb-6">
              Delivering exceptional digital solutions to help businesses thrive in the modern marketplace.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="#" className="text-white/80 hover:text-accent transition-colors">Careers</a></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="#" className="text-white/80 hover:text-accent transition-colors">Case Studies</a></li>
              <li><a href="#" className="text-white/80 hover:text-accent transition-colors">Documentation</a></li>
        ...
        <div className="border-t border-white/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 text-sm">
            ...
            <a href="#" className="text-white/70 hover:text-accent transition-colors">Cookies Policy</a>
          </div>
        </div>
      </div>
    </footer>
